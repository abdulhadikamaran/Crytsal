...
⚡ **[Download the Latest Release](https://github.com/abdulhadikamaran/Crytsal/releases/tag/v1.1.0)**
...
3. **100% Free & Open Source:** It uses the exact same level of AI as premium subscriptions (GPT-OSS 120B / Llama 70B), but because you plug in your own free Groq API key, you never pay a subscription fee.
...
- **Context-Aware:** Uses a fast 20B model (GPT-OSS 20B) for short typos, and a massive 120B model (GPT-OSS 120B) for complex, technical paragraphs.
...
1. Go to the [Releases page](https://github.com/abdulhadikamaran/Crytsal/releases/tag/v1.1.0) and download `CrystalAI-v1.1.0.zip`.
